...
class SettingsClientFixtureV1 {
  ...
  void testCrudOperations() async {
    // Create one section
      var parameters = await _client.setSection(null, 'test.1', ConfigParams.fromTuples(['key1', 'value11', 'key2', 'value12']));

      expect(parameters, isNotNull);
      expect(parameters['key1'], 'value11');

      // Create another section
      parameters = await _client.modifySection(null, 'test.2', ConfigParams.fromTuples(['key1', 'value21']), ConfigParams.fromTuples(['key2', 1]));
